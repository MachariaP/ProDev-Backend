...
# URL patterns - these will be included under api/v1/education/ by chamahub/urls.py
urlpatterns = [
    ...
    # Special endpoints
    path('dashboard/stats/', EducationDashboardViewSet.as_view({'get': 'overview'}), name='education-dashboard-stats'),
